package com.isuper.base.server.uaa.config;
...
public class CacheConfiguration {
        ...
        log.info("Defining Infinispan Global Configuration");
            if (this.registration == null) { // if registry is not defined, use native discovery
                ...
                return () -> GlobalConfigurationBuilder
                    ...
                    .clusterName("infinispan-UaaApplication-cluster").globalJmxStatistics()
    ...
    class InfinispanJCacheManager extends JCacheManager {
        ...
        public InfinispanJCacheManager(URI uri, EmbeddedCacheManager cacheManager, CachingProvider provider,
            ...
            registerPredefinedCache(com.isuper.base.server.uaa.repository.UserRepository.USERS_BY_LOGIN_CACHE, new JCache<Object, Object>(
                cacheManager.getCache(com.isuper.base.server.uaa.repository.UserRepository.USERS_BY_LOGIN_CACHE).getAdvancedCache(), this,
                ConfigurationAdapter.create()));
            registerPredefinedCache(com.isuper.base.server.uaa.repository.UserRepository.USERS_BY_EMAIL_CACHE, new JCache<Object, Object>(
                cacheManager.getCache(com.isuper.base.server.uaa.repository.UserRepository.USERS_BY_EMAIL_CACHE).getAdvancedCache(), this,
                ConfigurationAdapter.create()));
            registerPredefinedCache(com.isuper.base.server.uaa.domain.User.class.getName(), new JCache<Object, Object>(
                cacheManager.getCache(com.isuper.base.server.uaa.domain.User.class.getName()).getAdvancedCache(), this,
                ConfigurationAdapter.create()));
            registerPredefinedCache(com.isuper.base.server.uaa.domain.Authority.class.getName(), new JCache<Object, Object>(
                cacheManager.getCache(com.isuper.base.server.uaa.domain.Authority.class.getName()).getAdvancedCache(), this,
                ConfigurationAdapter.create()));
            registerPredefinedCache(com.isuper.base.server.uaa.domain.User.class.getName() + ".authorities", new JCache<Object, Object>(
                cacheManager.getCache(com.isuper.base.server.uaa.domain.User.class.getName() + ".authorities").getAdvancedCache(), this,
                ConfigurationAdapter.create()));
